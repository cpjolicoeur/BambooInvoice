...
<div class="work_description">
	<table class="invoice_items">
      ...
      <td nowrap="nowrap"><p><label><span><?php echo $this->lang->line('invoice_amount');?></span><?php echo $this->settings_model->get_setting('currency_symbol');?><input type="text" id="amount" name="items[1][amount]" size="5" value="<?php echo $row->default_rate; ?>" onkeyup="recalculate_items();" /></label></p></td>
			<td>&nbsp;</td>
		</tr>
		</tbody>
	</table>
